  ...
  <section id="projects" class="py-20 px-6 bg-gradient-to-br from-indigo-50 to-white">
    <div class="container mx-auto">
      <div class="flex flex-col md:flex-row md:justify-between md:items-end mb-12">
        <div>
          <h2 class="text-3xl font-bold mb-2 text-gray-800">Notable Projects & Achievements</h2>
      ...
      <div class="grid md:grid-cols-2 gap-8">
        <!-- Project 1: PrivaCT -->
        <ProjectCard
          title="PrivaCT: Trust-Minimized Certificate Transparency"
          tagline="Hackathon Winner"
          description="Winner of the 2025 Mammothan by Celestia. Developed a browser extension leveraging Prism to deliver trust-minimized Certificate Transparency directly to users, protecting against man-in-the-middle attacks and enhancing web security."
          :technologies="['TypeScript', 'Blockchain', 'Web Security', 'Browser Extension']"
          colorScheme="green"
          ...
          fullDescription="PrivaCT addresses a critical security gap in web browsing by verifying that website certificates are properly logged in transparency logs. This prevents man-in-the-middle attacks and enhances internet security."
          :features="[
        ...
        <ProjectCard
          title="Sustained: Pro-Environmental Behavior Platform"
          tagline="Thesis Project"
          description="A digital platform designed to foster pro-environmental behavior in Aachen by bridging the gap between environmental awareness and consistent action through innovative funding mechanisms and impact visualization."
          :technologies="['React', 'TypeScript', 'Tailwind CSS', 'Quadratic Funding']"
          colorScheme="blue"
          ...
          fullDescription="This thesis project conceptualized Sustained, a digital platform designed to foster pro-environmental behavior (PEB) in Aachen by bridging the gap between environmental awareness and consistent action. The research addressed key challenges identified through a comprehensive literature review and an initial local needs assessment."
          :features="[
        ...
        <div class="p-6">
          <div class="grid md:grid-cols-2 gap-4">
            <div class="flex">
              ...
              <div>
                <h4 class="font-semibold text-gray-800">Mammothan 2025 Winner</h4>
                <p class="text-gray-600">Winner of the 2025 Mammothan hackathon by Celestia with the PrivaCT project</p>
              </div>
            </div>
            ...
            <div class="flex">
              ...
              <div>
                <h4 class="font-semibold text-gray-800">Web3 Community Partner</h4>
                <p class="text-gray-600">Organized hackathon side events, workshops, and community events for Solana, Celestia, and ICP</p>
              </div>
            </div>
            ...
            <div class="flex">
              ...
              <div>
                <h4 class="font-semibold text-gray-800">Open Source Contributor</h4>
                <p class="text-gray-600">Active contributor to blockchain and web3 open source projects</p>
              </div>
            </div>
            ...
            <div class="flex">
              ...
              <div>
                <h4 class="font-semibold text-gray-800">Web3 Researcher</h4>
                <p class="text-gray-600">Contributing to growthepie with cutting-edge research on Ethereum ecosystem growth</p>
              </div>
            </div>
          </div>
        </div>
